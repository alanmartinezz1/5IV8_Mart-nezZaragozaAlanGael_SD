...
public class SClient {
    ...
    //Cada cliente tiene su hilo
    class Listen extends Thread {

        SClient TheClient;

        //Creacion de objetos para el hilo
        Listen(SClient TheClient) {
            this.TheClient = TheClient;
        }

        public void run() {
            //Cuando el cliente este conectado
            while (TheClient.soket.isConnected()) {
                try {
                    ...
                    Logger.getLogger(SClient.class.getName()).log(Level.SEVERE, null, ex);
                    //Elimina de la lista si se desconecta.
    ...
    //cada cliente tiene su hilo independiente.
